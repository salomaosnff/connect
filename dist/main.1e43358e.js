...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"node_modules/vue/dist/vue.runtime.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"src/lib/p2p/Room.js":[function(require,module,exports) {
"use strict";
...
var Room = _vue.default.extend({
  ...
  data: function data() {
    return {
      io: (0, _socket.default)(this.signalingUrl, {
        autoConnect: false
      }),
      connected: false,
      peers: {}
  ...
  created: function created() {
    ...
    this.io.on("offer", function (_ref) {
      var from = _ref.from,
          data = _ref.data;
      return _this.acceptOffer(from, data);
    });
    this.io.on("answer", function (_ref2) {
      var from = _ref2.from,
          data = _ref2.data;
      return _this.receiveAnswer(from, data);
    });
    this.io.on("icecandidates", function (_ref3) {
      var from = _ref3.from,
          data = _ref3.data;
      return _this.setCandidates(from, data);
    });
  },
  methods: {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", new Promise(function (resolve) {
                  _this2.io.once("connect", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                          ...
                          case 0:
                            _this2.io.emit("join", {
                              ...
                              var _ref5$users = _ref5.users,
                                  users = _ref5$users === void 0 ? [] : _ref5$users;
                              users.forEach(function (p) {
                                return _this2.createPeer(p);
                              });
                              resolve();
                            });
    ...
    getPeer: function getPeer(id, name) {
    ...
    removePeer: function removePeer(id) {
      if (this.peers[id]) {
        this.peers[id].disconnect();
        this.$delete(this.peers, id);
      }
    },
    acceptOffer: function acceptOffer(from, offer) {
      var _this3 = this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                peer = _this3.getPeer(from.id, from.name);
                if (!peer.connection) peer.initConnection();
                return _context3.abrupt("return", peer.createAnswer(offer).then(function (answer) {
                  return _this3.sendUserSignal(from.id, "answer", answer);
                }));
    ...
    receiveAnswer: function receiveAnswer(from, answer) {
      var _this4 = this;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                peer = _this4.getPeer(from.id, from.name);
                return _context4.abrupt("return", peer.setAnswer(answer));
    ...
    sendRoomSignal: function sendRoomSignal(event, data) {
      this.io.emit("signal", {
        event: event,
        data: data
      });
    },
    sendUserSignal: function sendUserSignal(userId, event, data) {
      this.io.emit("user-signal", {
        userId: userId,
        event: event,
        data: data
      });
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _this5.peers[_this5.io.id] = (_this5.peers[_this5.io.id] || []).filter(function (s) {
                  return s.enabled;
                });

                _this5.peers[_this5.io.id].push(stream);

                return _context5.abrupt("return", stream);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _this6.peers[_this6.io.id] = (_this6.peers[_this6.io.id] || []).filter(function (s) {
                  return s.enabled;
                });

                _this6.peers[_this6.io.id].push(stream);
    ...
    createPeer: function createPeer(_ref6) {
      var _this7 = this;
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                id = _ref6.id, name = _ref6.name;
                console.log("CREATE PEER", id);
                peer = _this7.getPeer(id, name);
                peer.initConnection.apply(peer, _toConsumableArray(_this7.streams[_this7.io.id] || []));
  ...
  computed: {
    streams: function streams() {
      return Object.entries(this.peers).reduce(function (obj, _ref7) {
        var _ref8 = _slicedToArray(_ref7, 2),
            k = _ref8[0],
            p = _ref8[1];

        return _objectSpread({}, obj, _defineProperty({}, k, p.streams));
      }, {});
    }
  },
  render: function render(h) {
...
exports.Room = Room;
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","socket.io-client":"node_modules/socket.io-client/lib/index.js","./Peer":"src/lib/p2p/Peer.js"}],"src/lib/p2p/Peer.js":[function(require,module,exports) {
"use strict";
...
var Peer = /*#__PURE__*/function () {
  ...
  _createClass(Peer, [{
    key: "offerMedia",
    value: function () {
      var _offerMedia = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this2 = this;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref$audio = _ref.audio, audio = _ref$audio === void 0 ? true : _ref$audio, _ref$video = _ref.video, video = _ref$video === void 0 ? false : _ref$video;
                _context.next = 3;
              ...
              case 3:
                ...
                stream.getTracks().forEach(function (track) {
                  return _this2.rtc.addTrack(track, stream);
                });
      ...
      function offerMedia() {
        return _offerMedia.apply(this, arguments);
      }
    ...
    key: "createOffer",
    value: function () {
      var _createOffer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var _this3 = this;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this.rtc.createOffer().then(function (offer) {
                  return _this3.rtc.setLocalDescription(offer);
                }).then(function () {
                  return _this3.rtc.localDescription;
                }));
    ...
    key: "createAnswer",
    value: function () {
      var _createAnswer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(offer) {
        var _this4 = this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", this.rtc.setRemoteDescription(offer).then(function () {
                  return _this4.rtc.createAnswer();
                }).then(function (answer) {
                  return _this4.rtc.setLocalDescription(answer);
                }).then(function () {
                  return _this4.rtc.localDescription;
                }));
    ...
    key: "setAnswer",
    value: function () {
      var _setAnswer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(answer) {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", this.rtc.setRemoteDescription(answer));
...
},{"./Room":"src/lib/p2p/Room.js"}],"src/lib/p2p/SignallingClient.js":[function(require,module,exports) {
"use strict";
...
var SignallingClient = /*#__PURE__*/function () {
  function SignallingClient() {
    _classCallCheck(this, SignallingClient);
  }

  _createClass(SignallingClient, [{
    key: "emit",
     ...
     */
    value: function emit(event, data, from, to) {
...
},{"./Peer":"src/lib/p2p/Peer.js"}],"src/lib/p2p/in-memory-signaling.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MemorySignaling = void 0;

var _SignallingClient2 = require("./SignallingClient");
...
var MemorySignaling = /*#__PURE__*/function (_SignallingClient) {
  _inherits(MemorySignaling, _SignallingClient);

  var _super = _createSuper(MemorySignaling);

  function MemorySignaling() {
    var _this;

    _classCallCheck(this, MemorySignaling);
  ...
  _createClass(MemorySignaling, [{
    ...
    value: function emit(event, data, from, to) {
      ...
      if (to) {
        ...
        listeners.forEach(function (item) {
          return item.listener(data, from);
        });
      }
    ...
    key: "on",
    value: function on(event, listener, peerId) {
      var listeners = this._listeners.get(event) || [];
      listeners.push({
        listener: listener,
        peerId: peerId
...
}(_SignallingClient2.SignallingClient);

exports.MemorySignaling = MemorySignaling;
},{"./SignallingClient":"src/lib/p2p/SignallingClient.js"}],"src/lib/p2p/PeerManager.js":[function(require,module,exports) {
"use strict";
...
var _inMemorySignaling = require("./in-memory-signaling");

var _SignallingClient = require("./SignallingClient");
...
var PeerManager = /*#__PURE__*/function () {
  function PeerManager() {
    ...
    this.signaling = new _inMemorySignaling.MemorySignaling();
    this.signaling.on("offer", function (data, id) {
      var peer = _this.peers[id] || new _Peer.Peer(id);
      peer.createAnswer(offer).then(function (answer) {
        return _this.signaling.emit("answer", answer, peer.id);
      });
      _this.peers[id] = peer;
    });
  }
  ...
  _createClass(PeerManager, [{
    key: "add",
    value: function () {
      var _add = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(peer) {
        var offer;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                offer = _context.sent;
                this.signaling.emit("offer", offer, peer.id).on("answer", function (data, from) {
                  return peer.setAnswer(data);
                }, peer.id).on("icecandidate", function (candidate) {
                  return peer.rtc.addIceCandidate(candidate);
                });
...
var p = new PeerManager();
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./Peer":"src/lib/p2p/Peer.js","./in-memory-signaling":"src/lib/p2p/in-memory-signaling.js","./SignallingClient":"src/lib/p2p/SignallingClient.js"}],"src/lib/p2p/index.js":[function(require,module,exports) {
"use strict";
...
Object.keys(_PeerManager).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _PeerManager[key];
    }
  });
});
...
},{"./Peer":"src/lib/p2p/Peer.js","./PeerManager":"src/lib/p2p/PeerManager.js","./Room":"src/lib/p2p/Room.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
      ...
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                userA = new _p2p.PeerManager();
                userB = new _p2p.PeerManager();
                userB.signaling = userA.signaling;
                p1 = new _p2p.Peer('p1');
                _context2.next = 6;
                return p1.offerMedia({
                  audio: true,
                  video: true
                });
...
exports.default = _default;
        var $63c2a0 = exports.default || module.exports;
      
      if (typeof $63c2a0 === 'function') {
        $63c2a0 = $63c2a0.options;
      }
    
        /* template */
        Object.assign($63c2a0, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$63c2a0', $63c2a0);
          } else {
            api.reload('$63c2a0', $63c2a0);
          }
        }
...
},{"./lib/p2p":"src/lib/p2p/index.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/vue-router/dist/vue-router.esm.js":[function(require,module,exports) {
"use strict";
...
var router = new _vueRouter.default({
  ...
  routes: [{
    ...
    component: function component() {
      return require("_bundle_loader")(require.resolve('./views/Call.vue'));
    }
  }]
});
exports.router = router;
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","vue-router":"node_modules/vue-router/dist/vue-router.esm.js","_bundle_loader":"node_modules/parcel-bundler/src/builtins/bundle-loader.js","./views/Call.vue":[["Call.53ab13ae.js","src/views/Call.vue"],"Call.53ab13ae.js.map","Call.53ab13ae.css","src/views/Call.vue"]}],"src/main.js":[function(require,module,exports) {
"use strict";
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","./router":"src/router.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
